...
特定のお店に行きたい、どこかに行ったついでに近辺で飲みたい、業務後に会社のメンバーで飲みたいなどの場合です。ライブ後のオフ会など、特定にエリアなら集まりやすいことが事前に分かっているというのもこのパターンに当てはまります。
...
ここまでで判明した情報を基にして会場が満たすべき条件を決めましょう。
必須条件と望ましい条件との切り分けもできれば、よりスムーズに絞り込みが行えます。
...
- クチコミは参考になる
  ...
  - プラスのクチコミは安心材料
  - 複数のサイトでそれが見られればまず安心
  - Google マップのクチコミに対してお店が返信してる場合は安心感がある(ものすごく主観)
- 確認項目のリストを作ろう
...
- つまみを作る場合
  ...
  - レシピ本は便利
    - コラム：オレンジページはやっぱり主婦(主夫)の味方。dancyu はドヤれる。
  - 軽く一手間
    - 缶詰のアレンジはやりやすい
